...
public class ActionMenuController {
    ...
    @GetMapping("/add-menu")
    public String menuAddPair(@RequestParam(name = "id") int id,
                              Model model){
    ...
    public String menuSearchPair(@RequestParam(name = "id") int id,
                                 Model model){
        model.addAttribute(ID, id);
    ...
    public String menuDeletePair(@RequestParam(name = "id") int id,
                                 Model model){
        model.addAttribute(ID, id);
    ...
    public String workWithLibrary(@RequestParam(name = "id") int id, Model model) {
        model.addAttribute(ID, id);
